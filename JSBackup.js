...
const audioBookPlaylist = [
	{
		...
		imageSource: require('./assets/cover.jpg'),
	},
	{
		uri:require('./assets/last_night.mp3'),
		imageSource: require('./assets/cover1.jpg'),
	},
	{
		uri: require('./assets/missing_you.mp3'),
	...
	{
	    uri: require('./assets/last_night.mp3'),
		imageSource: require('./assets/cover3.jpg')
	}
]

export default class Appsss extends Component {
	constructor(props) {
		super(props);
		this.index = 0;
